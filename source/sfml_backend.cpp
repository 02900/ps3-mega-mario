...
const int BATCH_MAX_VERTS = 262144;  // ~43690 quads/frame; 8 MB CPU buffer (fits the 32k-sprite benchmark stage in one upload)
const int BATCH_MAX_RUNS  = 49152;   // worst case: one run per quad (multi-texture)
