#!/usr/bin/env bash
#
# Send the Ki Blast Arena .self to a PS3 running the ps3load network receiver,
...
#                         (default: ghcr.io/02900/ps3-toolchain-tiny3d:latest)
#
...
IMAGE="${PS3_TOOLCHAIN_IMAGE:-ghcr.io/02900/ps3-toolchain-tiny3d:latest}"
